...
const PATH = "/reservations" as const;

export async function generateMetadata({ params: { locale } }: Props): Promise<Metadata> {
  const t = await getTranslations({ locale, namespace: "seo.reservations" });
...
export default function ReservationsPage({ params: { locale } }: Props) {
