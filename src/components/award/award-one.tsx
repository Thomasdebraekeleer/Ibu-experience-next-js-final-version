...
const award_data = [
  {
    ...
    img: a_1,
    subtitle: "1",
    title: "Drop your bag and your worries.",
    date: "Jun 24, 2024",
  },
  {
    id: 2,
    img: a_2,
    subtitle: "2",
    title: "Switch off your phone turn on your senses.",
    date: "Nov 24, 2022",
  },
  {
    id: 3,
    img: a_3,
    subtitle: "3",
    title: "Wrap yourself in a soft robe.",
    date: "May 24, 2012",
  },
  {
    id: 4,
    img: a_4,
    subtitle: "4",
    title: "Breathe in the stillness.",
    date: "Sep 10, 2021",
  },
  {
    id: 5,
    img: a_5,
    subtitle: "5",
    title: "Reconnect with nature, and the ones you love.",
    date: "Jun 12, 2021",
  },
  {
    id: 6,
    img: a_6,
    subtitle: "6",
    title: "Welcome to your moment out of time.",
    date: "Aug 18, 2022",
  },
];
    ...
    <div className={`tp-award-area ${cls}`}>
      <div className="container container-1630">
                                                      ...
                                                      <div className="col-xl-4 col-lg-4 col-md-12">
                                                                                <div className="tp-award-list-thumb-wrap p-relative d-flex align-items-center justify-content-center" style={{minHeight: '400px'}}>
                   <div
                     id="tp-award-thumb"
