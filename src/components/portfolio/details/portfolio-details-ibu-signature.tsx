...
const ChefIcon = () => (
  <svg fill="#053725" height="24px" width="24px" version="1.1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
    <g>
      <g>
        <path d="M256,0C114.6,0,0,114.6,0,256s114.6,256,256,256s256-114.6,256-256S397.4,0,256,0z M256,480
          c-123.5,0-224-100.5-224-224S132.5,32,256,32s224,100.5,224,224S379.5,480,256,480z"/>
        <path d="M256,64c-17.7,0-32,14.3-32,32s14.3,32,32,32s32-14.3,32-32S273.7,64,256,64z"/>
        <path d="M256,160c-17.7,0-32,14.3-32,32s14.3,32,32,32s32-14.3,32-32S273.7,160,256,160z"/>
        <path d="M256,256c-17.7,0-32,14.3-32,32s14.3,32,32,32s32-14.3,32-32S273.7,256,256,256z"/>
        <path d="M256,352c-17.7,0-32,14.3-32,32s14.3,32,32,32s32-14.3,32-32S273.7,352,256,352z"/>
      </g>
    </g>
  </svg>
);
...
const MenuIcon = () => (
  <svg fill="#053725" height="24px" width="24px" version="1.1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
    <g>
      <g>
        <path d="M64,96c-8.8,0-16,7.2-16,16v288c0,8.8,7.2,16,16,16h384c8.8,0,16-7.2,16-16V112c0-8.8-7.2-16-16-16H64z M64,112h384v288H64V112z"/>
        <path d="M80,128h352v32H80V128z"/>
        <path d="M80,176h352v32H80V176z"/>
        <path d="M80,224h352v32H80V224z"/>
        <path d="M80,272h352v32H80V272z"/>
        <path d="M80,320h352v32H80V320z"/>
        <path d="M80,368h352v32H80V368z"/>
      </g>
    </g>
  </svg>
);
  ...
  <svg fill="#053725" height="24px" width="24px" version="1.1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
    <g>
      <g>
        <path d="M256,0C114.6,0,0,114.6,0,256s114.6,256,256,256s256-114.6,256-256S397.4,0,256,0z M256,480
          c-123.5,0-224-100.5-224-224S132.5,32,256,32s224,100.5,224,224S379.5,480,256,480z"/>
        <path d="M256,64c-17.7,0-32,14.3-32,32v128c0,17.7,14.3,32,32,32s32-14.3,32-32V96C288,78.3,273.7,64,256,64z"/>
        <path d="M256,256c-17.7,0-32,14.3-32,32v64c0,17.7,14.3,32,32,32s32-14.3,32-32v-64C288,270.3,273.7,256,256,256z"/>
      </g>
    </g>
  </svg>
);
...
const DinerIcon = () => (
  <svg fill="#053725" height="24px" width="24px" version="1.1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1024 1024">
    <g>
      <path d="M480 257.152V192h-96a32 32 0 0 1 0-64h256a32 32 0 1 1 0 64h-96v65.152A448 448 0 0 1 955.52 768H68.48A448 448 0 0 1 480 257.152zM128 704h768a384 384 0 1 0-768 0zM96 832h832a32 32 0 1 1 0 64H96a32 32 0 1 1 0-64z"/>
    </g>
  </svg>
);
...
// shape image for IBÙ Signature
import signature_shape from "@/assets/img/home-02/service/Picture ibu Signature.jpg";
...
export default function PortfolioDetailsIBUSignature() {
  ...
  return (
    ...
    {/* Services Section - Added after "Notre Mission" */}
    ...
    {/* details area */}
    <div className="showcase-details-2-area" style={{paddingBottom: '30px'}}>
        <div className="container">
          <div className="row">
              <div className="col-xl-12">
                <div className="showcase-details-2-section-box">
          ...
          {/* Photos intégrées dans la section L'Excellence */}
          ...
          {/* Bouton intégré dans la section L'Excellence */}
