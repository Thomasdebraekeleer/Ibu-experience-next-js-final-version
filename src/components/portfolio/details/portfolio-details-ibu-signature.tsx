...
const service_accordion_signature = [
  ...
  },
  {
    ...
    desc: "Faites confiance à notre chef et laissez-vous emporter par des saveurs locales et de saison, sublimées dans un menu raffiné. Une alternative végétarienne est disponible sur simple demande lors de votre réservation.",
  },
  {
    id: 5,
